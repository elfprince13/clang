...
bool types::isAcceptedByClang(ID Id) {
  ...
  case TY_CL:
  case TY_CUDA: case TY_PP_CUDA: case TY_SKEL:
  case TY_CUDA_DEVICE:
...
bool types::isCXX(ID Id) {
  ...
  case TY_CXXHeader: case TY_PP_CXXHeader:
  case TY_ObjCXXHeader: case TY_PP_ObjCXXHeader:
  case TY_CUDA: case TY_PP_CUDA: case TY_SKEL: case TY_CUDA_DEVICE:
    return true;
  }
}
...
/* Not sure offhand if TY_SKEL belongs here or not. Probably, so we'll go with it */
  switch (Id) {
  default:
    return false;
